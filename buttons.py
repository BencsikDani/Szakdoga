...
class Buttons:
    def initButtons():
        ...
        GPIO.add_event_detect(17, GPIO.RISING, callback=Buttons.b1_callback)
        GPIO.add_event_detect(18, GPIO.RISING, callback=Buttons.b2_callback)
        GPIO.add_event_detect(19, GPIO.RISING, callback=Buttons.b3_callback)
        GPIO.add_event_detect(20, GPIO.RISING, callback=Buttons.b4_callback)
        GPIO.add_event_detect(21, GPIO.RISING, callback=Buttons.b5_callback)
        return
    ...
    def b2_callback(self):
        ...
        if Globals.currentScreenState == Globals.screenState.MENU:
            if (Globals.menuPos == 2) or (Globals.menuPos == 3) or (Globals.menuPos == 5) or (Globals.menuPos == 6):
                Globals.menuPos -= 1
        if Globals.currentScreenState == Globals.screenState.LEDMENU:
            if (Globals.LEDMenuPos == 2) or (Globals.LEDMenuPos == 4) or (
                    (6 <= Globals.LEDMenuPos) and (Globals.LEDMenuPos <= 8)):
